...
public class IniPreferences extends AbstractPreferences {
   ...
   */
  public IniPreferences(Reader input) throws IniException {
    super(null, "");
    _ini = new Ini(input);
  }
   ...
   * @throws InvalidFileFormatException if <code>Ini</code> parsing error occured
   */
  public IniPreferences(InputStream input) throws IniException {
    super(null, "");
    _ini = new Ini(input);
  }
   ...
   * @throws IniException                if an I/O error occured
   */
  public IniPreferences(URL input) throws IniException {
    super(null, "");
    _ini = new Ini(input);
  }
