...
public class ConfigParser implements Serializable {
  ...
  public boolean getBoolean(String section, String option) throws IniException {
    boolean ret;
    ...
    if ("1".equalsIgnoreCase(value) || "yes".equalsIgnoreCase(value) || "true".equalsIgnoreCase(value) || "on".equalsIgnoreCase(value)) {
      ...
      throw new IniException(value);
    }

    return ret;
  }

  public double getDouble(String section, String option) throws IniException {
    return Double.parseDouble(get(section, option));
  }

  public float getFloat(String section, String option) throws IniException {
    return Float.parseFloat(get(section, option));
  }

  public int getInt(String section, String option) throws IniException {
    return Integer.parseInt(get(section, option));
  }

  public long getLong(String section, String option) throws IniException {
  ...
  public void addSection(String section) throws IniException {
    if (_ini.containsKey(section)) {
      throw new IniException(section);
  ...
  @SuppressWarnings(Warnings.UNCHECKED)
  public String get(String section, String option, boolean raw) throws IniException {
    return get(section, option, raw, Collections.EMPTY_MAP);
  }

  public String get(String sectionName, String optionName, boolean raw, Map<String, String> variables) throws IniException {
  ...
  @SuppressWarnings(Warnings.UNCHECKED)
  public List<Map.Entry<String, String>> items(String sectionName) throws IniException {
    return items(sectionName, false, Collections.EMPTY_MAP);
  }

  @SuppressWarnings(Warnings.UNCHECKED)
  public List<Map.Entry<String, String>> items(String sectionName, boolean raw) throws IniException {
    return items(sectionName, raw, Collections.EMPTY_MAP);
  }

  public List<Map.Entry<String, String>> items(String sectionName, boolean raw, Map<String, String> variables) throws IniException {
  ...
  public List<String> options(String sectionName) throws IniException {
    requireSection(sectionName);

    return new ArrayList<String>(_ini.get(sectionName).keySet());
  }

  public void read(String... filenames) throws IniException {
    for (String filename : filenames) {
      read(new File(filename));
    }
  }

  public void read(Reader reader) throws IniException {
    _ini.load(reader);
  }

  public void read(URL url) throws IniException {
    _ini.load(url);
  }

  public void read(File file) throws IniException {
    try {
  ...
  public void read(InputStream stream) throws IniException {
    _ini.load(stream);
  }

  public boolean removeOption(String sectionName, String optionName) throws IniException {
    Ini.Section section = requireSection(sectionName);
  ...
  public void set(String sectionName, String optionName, Object value) throws IniException {
    Ini.Section section = requireSection(sectionName);
    if (value == null) {
      section.remove(optionName);
    } else {
  ...
  private String requireOption(String sectionName, String optionName) throws IniException {
    Ini.Section section = requireSection(sectionName);
    String option = section.get(optionName);
    if (option == null) {
      throw new IniException(optionName);
    }
    return option;
  }

  private Ini.Section requireSection(String sectionName) throws IniException {
    Ini.Section section = _ini.get(sectionName);
    if (section == null) {
      throw new IniException(sectionName);
    }
    return section;
  }
  ...
  static class PyIni extends Ini {
    ...
    public String fetch(String sectionName, String optionName, Map<String, String> variables) throws IniException {
    ...
    protected String fetch(Ini.Section section, String optionName, Map<String, String> variables) throws IniException {
    ...
    protected void resolve(StringBuilder buffer, Ini.Section owner, Map<String, String> vars) throws IniException {
