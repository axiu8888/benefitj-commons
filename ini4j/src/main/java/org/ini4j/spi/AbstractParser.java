...
abstract class AbstractParser {
  ...
  protected void parseError(String line, int lineNumber) throws IniException {
    throw new IniException("parse error (at line: " + lineNumber + "): " + line);
  }
  ...
  IniSource newIniSource(URL input, HandlerBase handler) throws IniException {
    return new IniSource(input, handler, _comments, getConfig());
  }

  void parseOptionLine(String line, HandlerBase handler, int lineNumber) throws IniException {
