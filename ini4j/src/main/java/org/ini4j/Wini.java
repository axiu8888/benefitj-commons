...
public class Wini extends Ini {
  ...
  public Wini(File input) throws IniException {
    this();
    setFile(input);
    load();
  }

  public Wini(URL input) throws IniException {
    this();
    load(input);
  }

  public Wini(InputStream input) throws IniException {
    this();
    load(input);
  }

  public Wini(Reader input) throws IniException {
    this();
    load(input);
  }
