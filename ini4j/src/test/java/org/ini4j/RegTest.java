...
public class RegTest extends Ini4jCase {
  ...
  @Test
  public void testIniException() throws Exception {
    try {
      new Reg(Helper.getResourceReader(Helper.DWARFS_INI));
      missing(IniException.class);
    } catch (IniException x) {
      //
    }
  }
  ...
  @Test
  public void testLoadIniException() throws Exception {
    Reg reg = new Reg();
  ...
  @Test
  public void testStoreIniException() throws Exception {
    try {
      new Reg().store();
      missing(IniException.class);
    } catch (IniException x) {
