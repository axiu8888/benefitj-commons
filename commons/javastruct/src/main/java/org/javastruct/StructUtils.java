...
public class StructUtils {
  private static final Map<String, StructData> structInfoCache = new ConcurrentHashMap<String, StructData>();
  ...
  public static StructData getStructInfo(Object obj) throws StructException {
    ...
    if (obj.getClass().getAnnotation(StructClass.class) != null) {
      ...
      structInfoCache.putIfAbsent(obj.getClass().getName(), info);
      return info;
    }
