 ...
 * 16进制字符串转换
 */
public class UpperCaseHexStringConverter extends AbstractConverter<String> {

  public UpperCaseHexStringConverter() {
  }

  public UpperCaseHexStringConverter(boolean local) {
    super(local);
  }
  ...
  public String parse(Object obj, StructField field, byte[] data, int position) {
    ...
    return getBinary().bytesToHex(buf, false);
  }
