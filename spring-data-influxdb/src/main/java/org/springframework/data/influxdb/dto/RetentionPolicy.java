package org.springframework.data.influxdb.dto;
...
public class RetentionPolicy {
  ...
  public RetentionPolicy(String name, String duration, String shardGroupDuration, long replicaN, boolean defaultFlag) {
    this.name = name;
