...
public enum Cmd {
  ...
  exhale_assess(Type.MODE, "呼气肌力评估模式", 100, 111, 10, 14, true),
  inhale_assess(Type.MODE, "吸气肌力评估模式", 100, 112, 18, 14, true),
  exhale_train(Type.MODE, "呼气肌力训练", 100, 121, 62, 14, true),
  inhale_train(Type.MODE, "吸气肌力训练", 100, 122, 69, 14, true),
  lip_girdle_train(Type.MODE, "吸气肌力评估模式", 100, 123, 76, 12, true),
  resistance(Type.MODE, "阻力", 151, 0, 0, 0, false),
  gears(Type.MODE, "缩唇呼吸档位", 152, 0, 0, 0, false),
