...
/**
 * 程序启动时自动上传InfluxDB文件的监听
 */
public class AutoInfluxWriteListener implements ApplicationListener<ApplicationReadyEvent> {

  private static final Logger logger = LoggerFactory.getLogger(AutoInfluxWriteListener.class);

  private InfluxDBTemplate template;
  private InfluxDBWriteProperty property;

  public AutoInfluxWriteListener() {
  }

  public AutoInfluxWriteListener(InfluxDBTemplate template, InfluxDBWriteProperty property) {
  ...
  public void setProperty(InfluxDBWriteProperty property) {
    this.property = property;
  }
