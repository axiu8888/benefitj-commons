...
import org.influxdb.impl.BasicInfluxDBImpl;
 ...
 */
public enum BasicInfluxDBFactory {
  /* default */;
   ...
   */
  public static BasicInfluxDB connect(final String url) {
    Preconditions.checkNonEmptyString(url, "url");
    return new BasicInfluxDBImpl(url, null, null, new OkHttpClient.Builder());
  }
   ...
   * @return a InfluxDB adapter suitable to access a InfluxDB.
   */
  public static BasicInfluxDB connect(final String url, final String username, final String password) {
    Preconditions.checkNonEmptyString(url, "url");
    Preconditions.checkNonEmptyString(username, "username");
    return new BasicInfluxDBImpl(url, username, password, new OkHttpClient.Builder());
  }
   ...
   * @return a InfluxDB adapter suitable to access a InfluxDB.
   */
  public static BasicInfluxDB connect(final String url, final OkHttpClient.Builder client) {
    Preconditions.checkNonEmptyString(url, "url");
    Objects.requireNonNull(client, "client");
    return new BasicInfluxDBImpl(url, null, null, client);
  }
  ...
  public static BasicInfluxDB connect(final String url, final String username, final String password,
    ...
    Preconditions.checkNonEmptyString(username, "username");
    Objects.requireNonNull(client, "client");
    return new BasicInfluxDBImpl(url, username, password, client, responseFormat);
  }
}
